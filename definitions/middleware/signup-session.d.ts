...
export declare function customSession(Department: DepartmentModel): (req: express.Request, res: express.Response, next: express.NextFunction) => void | import("mongoose").DocumentQuery<(import("mongoose").Document & {
    _id: {
        type: {
            prototype: {} | {
                [x: string]: any;
